...
class Client {
	...
	// var $endpoint = 'http://api.2d.cx';
	// var $endpoint = 'http://dl-api.dev/api/index.php/';
	...
	public function get($segments) {
		return $this->parse(\Guzzle::get(self::$endpoint . $segments));
	}

	public function delete($segments) {
		return $this->parse(\Guzzle::delete(self::$endpoint . $segments));
	}
