...
//
// Completely based on illuminate/pagination class:
// https://github.com/illuminate/pagination/blob/master/Paginator.php
//
//
...
class Paginator implements ArrayableInterface, ArrayAccess, Countable, IteratorAggregate, JsonableInterface
{
     ...
     * @return void
     */
    public function __construct($env, array $items, $total, $perPage)
    {
        $this->env = $env;
        $this->items = $items;
